...
public class AntaletResande {
    ...
    @FXML
    private TextField tfbetalkort; // Ändra till rätt :D
    ...
    public void initialize() {
        btnNÄSTA.setOnAction(event -> {
            ...
            storeTravelChoices.storeTextFieldValue(tfbetalkort.getText(), "Antal resande: ");
            Stage stage = (Stage) btnNÄSTA.getScene().getWindow();
            sideBarButtons.sideBarButton("/com/uu/grupp3/marstravel/resedatum.fxml", stage);
        });
    }
